...
import cn.jzvd.demo.frg.Video_MainActivity;
...
public class ActivityMain extends AppCompatActivity implements View.OnClickListener {
    ...
    Button mTinyWindow, mListView, mDirectFullscreen, mApi, mWebView,fragment;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.webview:
                ...
                break;
            case R.id.fragment:
                startActivity(new Intent(ActivityMain.this, Video_MainActivity.class));
                break;
        }
    }
